...
\pagestyle{fancy}
\fancyhf{}
\rhead{\small\textit{geneOptimize v1.1.0}}
...
% =============================================================================
\section{Summary of Changes in v1.1.0}
% =============================================================================
...
interface keeps common use cases concise. Version 1.1.0 focuses on
correctness, usability, and testability --- making the package suitable for
both research prototyping and production variable selection pipelines.
